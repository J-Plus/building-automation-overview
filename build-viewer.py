...
new Chart(document.getElementById('chartTrainingROI'), {
  type: 'bar',
  data: {
    labels: ['Profit Margin', 'Retention', 'Service Speed', 'Customer Satisfaction'],
    datasets: [{
      label: 'Improvement %',
      data: [24, 40, 20, 15],
      backgroundColor: [chartColors.accent, chartColors.blue, chartColors.orange, chartColors.purple],
      borderWidth: 0,
      borderRadius: 4,
    }]
  },
